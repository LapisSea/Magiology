...
public class BlockScreen extends BlockContainerM<TileEntityScreen>{
	...
	public BlockScreen(){
		...
		setBlockBounds(new StateDependantBlockBounds(new AxisAlignedBB(0,p*5,0,1,1-p*5,1),new AxisAlignedBB(0,0,p*5,1,1,1-p*5),new AxisAlignedBB(p*5,0,0,1-p*5,1,1)){
			
			@Override
			public int chooseBox(IBlockState state){
