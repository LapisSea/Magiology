...
public class AdvancedRenderer{
	...
	protected void tesselateLines(ShadedQuad triangle){
		Vec3M vecs[]={MatrixUtil.transformVector(new Vec3M(triangle.pos4[0].vector3D), transformation), MatrixUtil.transformVector(new Vec3M(triangle.pos4[1].vector3D), transformation), MatrixUtil.transformVector(new Vec3M(triangle.pos4[2].vector3D), transformation), MatrixUtil.transformVector(
			new Vec3M(triangle.pos4[3].vector3D), transformation)};
