...
public abstract class PositionAwareEffect{
	...
	public static void updateViewTransformation(){
		...
		viewTransformation.translate(new Vector3f(-(float)TileEntityRendererDispatcher.staticPlayerX, -(float)TileEntityRendererDispatcher.staticPlayerY, -(float)TileEntityRendererDispatcher.staticPlayerZ));
