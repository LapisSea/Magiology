...
public abstract class IParticle{
	...
	public void moveEntity(Vec3M speed){
		...
		boolean 
			xColided=originalSpeed.x!=speed.x,
			yColided=originalSpeed.y!=speed.y,
			zColided=originalSpeed.z!=speed.z;
	...
	public abstract Queue<PositionTextureVertex> renderModel(float xRotation, float zRotation, float yzRotation, float xyRotation, float xzRotation);
