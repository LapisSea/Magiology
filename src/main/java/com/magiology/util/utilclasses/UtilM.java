...
public class UtilM{
	...
	public static boolean axisAlignedBBEqual(AxisAlignedBB box1, AxisAlignedBBM box2){
		return !isNull(box1, box2)&&box1.minX==box2.minX&&box1.minY==box2.minY&&box1.minZ==box2.minZ&&box1.maxX==box2.maxX&&box1.maxY==box2.maxY&&box1.maxZ==box2.maxZ;
	}
	public static boolean axisAlignedBBEqual(AxisAlignedBBM box1, AxisAlignedBB box2){
		return !isNull(box1, box2)&&box1.minX==box2.minX&&box1.minY==box2.minY&&box1.minZ==box2.minZ&&box1.maxX==box2.maxX&&box1.maxY==box2.maxY&&box1.maxZ==box2.maxZ;
	}
	public static boolean axisAlignedBBEqual(AxisAlignedBBM box1, AxisAlignedBBM box2){
		if(box1==box2) return true;
		return !isNull(box1, box2)&&box1.minX==box2.minX&&box1.minY==box2.minY&&box1.minZ==box2.minZ&&box1.maxX==box2.maxX&&box1.maxY==box2.maxY&&box1.maxZ==box2.maxZ;
	}
	...
	public static boolean intersectLinePlane(RayDeprecated ray,Plane plane, Vec3M result){
		...
		if(!xz){
			...
			RayTraceResult rayTrace=Plane.calculateIntercept(ray.from.add(0, 0.1, 0).conv(), ray.to.add(0, 0.1, 0).conv());
			...
			if(printProcess)PrintUtil.println("Ray trace has resolved a valid intersection point!");
			return true;
		}
	...
	public static void sendMessage(AbstractPacket message){
		...
		if(message instanceof AbstractToServerMessage)Magiology.NETWORK_CHANNEL.sendToServer(message);
			...
			if(msg.target!=null&&!msg.target.world.isRemote){
				...
				else if(msg.target.typeOfSending==TypeOfSending.ToDimension)Magiology.NETWORK_CHANNEL.sendToDimension(msg, msg.target.world.provider.getDimension());
			}
		}
	}
